...
pub enum Key<EC: ExtenderConfig> {
    ...
    AesGcm128(libcrux_aes::AesGcm128Key),
    AesGcm256(libcrux_aes::AesGcm256Key),
}

pub enum Tag<EC: ExtenderConfig> {
    Direct(AeadTagOf<EC::Base>),
    AesGcm128(libcrux_aes::AesGcm128Tag),
    AesGcm256(libcrux_aes::AesGcm256Tag),
}
...
impl<EC: ExtenderConfig> AeadProvider for Extender<EC> {
    ...
    fn encrypt_in_place(
        ...
        let tag = match key {
            ...
            Key::AesGcm128(key) => Tag::AesGcm128(encrypt::<libcrux_aes::AesGcm128, _, _>(
                &mut ciphertext,
                key,
                nonce,
                &aad,
            ...
            Key::AesGcm256(key) => Tag::AesGcm256(encrypt::<libcrux_aes::AesGcm256, _, _>(
                &mut ciphertext,
                key,
                nonce,
                &aad,
    ...
    fn decrypt_in_place(
        ...
        let res = match key {
            Key::Direct(_) => unreachable!(),
            Key::AesGcm128(key) => decrypt::<libcrux_aes::AesGcm128, _, _>(
                &mut ciphertext,
                key,
                nonce,
                &aad,
            ...
            Key::AesGcm256(key) => decrypt::<libcrux_aes::AesGcm256, _, _>(
                &mut ciphertext,
                key,
                nonce,
                &aad,
...
impl<EC: ExtenderConfig> embedded_cal::AeadAlgorithm for AeadAlgorithm<EC> {
    fn key_length(&self) -> usize {
        match self {
            ...
            AeadAlgorithm::AesGcm128 => libcrux_aes::AES_128_KEY_LEN,
            AeadAlgorithm::AesGcm256 => libcrux_aes::AES_256_KEY_LEN,
        }
    }
    ...
    fn tag_length(&self) -> usize {
        match self {
            ...
            AeadAlgorithm::AesGcm128 => libcrux_aes::AesGcm128::TAG_LEN,
            AeadAlgorithm::AesGcm256 => libcrux_aes::AesGcm256::TAG_LEN,
        }
    }
    ...
    fn nonce_length(&self) -> usize {
        match self {
            ...
            AeadAlgorithm::AesGcm128 => libcrux_aes::AesGcm128::NONCE_LEN,
            AeadAlgorithm::AesGcm256 => libcrux_aes::AesGcm256::NONCE_LEN,
        }
    }
